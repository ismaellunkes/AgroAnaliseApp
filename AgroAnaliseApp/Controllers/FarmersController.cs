...
namespace AgroAnaliseApp.Controllers
{
    public class FarmersController : Controller
    {
        ...
        public FarmersController(AgroAnaliseAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,BornDate,RegistryDate")] Farmer farmer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,BornDate,RegistryDate")] Farmer farmer)
        {
            if (id != farmer.Id)
            {
                return NotFound();
